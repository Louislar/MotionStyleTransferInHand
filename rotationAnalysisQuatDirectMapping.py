...
if __name__=='__main__':
    ...
    DBRotFilePath = 'bodyDBRotation/genericAvatar/quaternion/twoLegJump0.03_05_withHip.json'
    DBRefSeqOutputFilePath = 'rotationMappingQuatDirectMappingData/twoLegJump_body_ref.npy'
    handPerfFilePath = 'HandRotationOuputFromHomePC/twoLegJumpStream.json'
    handPerfRefSeqOutputFilePath = 'rotationMappingQuatDirectMappingData/twoLegJump_hand_ref.npy'
    MappedRotSaveDataPath = 'handRotaionAfterMapping/twoLegJump_quat_directMapping.json'
    cropInterval = {0: [94, 119], 1: [133, 144], 2: [94, 119], 3: [133, 144]}
    handPerfCropInterval = {0: [430, 669], 1: [932, 898], 2: [430, 669], 3: [932, 898]} # 最大值與最小值的index 
