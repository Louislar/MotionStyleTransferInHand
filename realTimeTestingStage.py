...
if __name__=='__main01__':
    ...
    # handRot = None
    # with open(rotComputeRetSaveDirPath+'jumpJoyStream.json', 'r') as WFile: 
    ...
    # rotMapRetFilePath = 'handRotaionAfterMapping/jumpJoy_quat_directMapping.json'
    # rotMapResult = None
    ...
    # 使用新的t pose資訊重新計算結果
    # rotApplyFilePath='positionData/jumpJoy_quat_directMapping.json'
    ...
    # with open(saveDirPath+'jumpJoy_075_quat_direct_EWMA.json') as RFile:
