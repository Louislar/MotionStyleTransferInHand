...
if __name__=='__main__':
    ...
    trajectoryNormalization(
        bodyPosFilePath = 'positionData/fromDB/genericAvatar/jumpJoyPositionFullJointsWithHead_withoutHip_075.json', 
        handMappedPosDirPath = 'positionData/jumpJoy_quat_directMapping.json', 
        normalizedBodyPosFilePath = 'positionData/fromDB/genericAvatar/jumpJoyPositionFullJointsWithHead_withoutHip_075_quat_direct_normalized.json',
        maxPercentile = 0.95,
        minPercentile = 0.05,
        normalizeAxis = ['x', 'y', 'z']  
    )
