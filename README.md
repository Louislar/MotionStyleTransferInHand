...
<!--     project_description -->
      ...
      <br />
      Another repository is necessary to reproduce the Storytelling application prototype. That repo includes a Unity project which receive the retargeted skeletal poses via Http protocal, and visualize the skeletal in a 3D scene.
    <br />
...
<!-- 需要解釋body skeletal的格式, hand就不需要了, 請讀者自己參考MediaPipe的說明 -->
...
1. Clone the repo
   ...
   ```
2. Check the server's ip and port 
3. Check the input source is webcam or a pre-recorded finger-walking video
